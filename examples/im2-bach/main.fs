\ examples/im2-bach/main.fs — entry point.
\
...
\ app/song-data.fs and was transcribed from the Mutopia LilyPond
\ source (typeset by Allen Garvin, public domain) — 312 16th-note
\ steps spanning 52 bars in 3/8.
\
...
\   source/               - the upstream LilyPond source for reproducibility
