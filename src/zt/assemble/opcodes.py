...
OPCODES: tuple[OpcodeSpec, ...] = (
    ...
    _no("sub_b",        0x90),
    _no("sbc_a_d",      0x9A),
    _nn("ld_ind_nn_hl", 0x22),
    _nn("ld_hl_ind_nn", 0x2A),
    _nn("ld_bc_ind_nn", 0xED, 0x4B),
    _nn("ld_ind_nn_bc", 0xED, 0x43),
    _no("ld_a_ind_bc",  0x0A),
    _no("ld_ind_bc_a",  0x02),
    _no("ld_ind_de_a",  0x12),
    _no("inc_ind_hl",   0x34),
    _no("dec_ind_hl",   0x35),
    _n ("ld_ind_hl_n",  0x36),
    _no("ccf",          0x3F),
